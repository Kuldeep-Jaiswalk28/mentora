...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadRecentActivity() {
        ...
        // Check if completed_tasks exists before using slice
        if (!activity.completed_tasks || activity.completed_tasks.length === 0) {
        ...
        // Check if new_goals exists before using slice
        if (!activity.new_goals || activity.new_goals.length === 0) {
        ...
        goalHtml += `
                ...
                <div class="col-md-4">
                    ...
                    ${progress.high_priority_tasks.length > 0 ? `
                        <div class="card mb-4"><previous_generation>```text
                        <div class="card-body">
